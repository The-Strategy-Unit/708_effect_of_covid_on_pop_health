...
# theme for project 708 -------------------------------------------------------
theme_708 <- function(base_size = 12.5, base_family = "Fira Sans") {
  ...
  theme(
    ...
    line = element_line(colour = "#2c2825", size = .5, linetype = 1, lineend = "butt"),
    rect = element_rect(fill = "#ffffff", colour = "#2c2825", size = .5, linetype = 1),
    text = element_text(
      family =       base_family
      , face =       "plain"
      , colour =     "#2c2825"
    ...
    , axis.line.x =        NULL
    , axis.line.y =        NULL
    , axis.text =          element_text(size = rel(.8), colour = "#686f73", hjust = 0)
    , axis.text.x =        element_text(margin = margin(t = .8 * half_line / 2), vjust = 1, hjust = .5)
    ...
    , axis.ticks =         element_line(size = .5, colour = "#686f73")
    , axis.ticks.length =  unit(2, "mm")
    , axis.ticks.x =       element_line(size = .4, color = "#d3d3d3")  
    ...
    , legend.key =            element_rect(fill = "#fffffc", colour = NA)
    ...
    , panel.grid.major.y = element_line(size = .2, color = "#d3d3d3")
    ...
    #, strip.text =            element_text(size = rel(.8), hjust = 0, vjust = .5, margin = margin(t = half_line * .5, l = half_line * .5))
